...
<div class="banner_section layout_padding">
   <div class="container">
      <div id="costum_slider" class="carousel slide" data-ride="carousel">
         ...
         <i class=""><img src="{{url('asset/images/left-arrow.png')}}"></i>
         </a>
         <a class="carousel-control-next" href="#costum_slider" role="button" data-slide="next">
         <i class=""><img src="{{url('asset/images/right-arrow.png')}}"></i>
         </a>
      </div>
   </div>
</div>
      ...
      <div class="services_section2 layout_padding">
         <div class="row">
            <div class="col-lg-3 col-sm-6">
               <div class="icon_1"><img src="{{url('asset/images/icon-1.png')}}"></div>
            ...
            <div class="col-lg-3 col-sm-6">
               <div class="icon_1"><img src="{{url('asset/images/icon-2.png')}}"></div>
            ...
            <div class="col-lg-3 col-sm-6">
               <div class="icon_1"><img src="{{url('asset/images/icon-3.png')}}"></div>
            ...
            <div class="col-lg-3 col-sm-6">
               <div class="icon_1"><img src="{{url('asset/images/icon-4.png')}}"></div>
...
<div class="about_section layout_padding">
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="image_1"><img src="{{url('asset/images/img-1.png')}}"></div>
         </div>
      </div>
   </div>
</div>
         ...
         <div class="row">
            <div class="col-md-6">
               <div class="container_main">
                  <img src="{{url('asset/images/img-2.png')}}" alt="Avatar" class="image">
                  <div class="overlay">
            ...
            <div class="col-md-6">
               <div class="container_main">
                  <img src="{{url('asset/images/img-3.png')}}" alt="Avatar" class="image">
                  <div class="overlay">
                     <a href="#" class="icon" title="User Profile">
                     <i class="fa fa-search"></i>
                     </a>
                     ...
                     <div class="row">
                        <div class="col-sm-4">
                           <div class="container_main1">
                              <img src="{{url('asset/images/img-4.png')}}" alt="Avatar" class="image" style="width:100%">
                        ...
                        <div class="col-sm-4">
                           <div class="container_main1">
                              <img src="{{url('asset/images/img-5.png')}}" alt="Avatar" class="image" style="width:100%">
                              <h1 class="modern_text">Modern home designe</h1>
                              <div class="middle">
                                 <div class="text">VIEW MORE</div>
                              </div>
                        ...
                        <div class="col-sm-4">
                           <div class="container_main1">
                              <img src="{{url('asset/images/img-6.png')}}" alt="Avatar" class="image" style="width:100%">
                              <h1 class="modern_text">Modern home designe</h1>
                              <div class="middle">
                                 <div class="text">VIEW MORE</div>
                              </div>
            ...
            <div class="carousel-item active">
               ...
               <div class="clients_section2 layout_padding">
                  <div class="client_1">
                     <div class="row">
                        <div class="col-sm-3">
                           <div class="image_7"><img src="{{url('asset/images/img-7.png')}}"></div>
                           <div class="quote_icon"><img src="{{url('asset/images/quote-icon.png')}}"></div>
                        </div>
                        <div class="col-sm-9">
                  ...
                  <div class="client_2">
                     <div class="row">
                        <div class="col-sm-3">
                           <div class="image_7"><img src="{{url('asset/images/img-8.png')}}"></div>
                           <div class="quote_icon"><img src="{{url('asset/images/quote-icon.png')}}"></div>
                        </div>
                        <div class="col-sm-9">
                           <h1 class="loksans_text">loksans</h1>
...
<div class="contact_section layout_padding">
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="image_9"><img src="{{url('asset/images/img-9.png')}}"></div>
         </div>
      </div>
   </div>
</div>
